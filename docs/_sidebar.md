- 目录
    - 第一章 解锁RAG
        - [第一节 RAG简介](chapter1/structure.md)
        - [第二节 准备工作](chapter1/grammar.md)
        - [第三节 四步构建RAG](chapter1/grammar.md)
        - [附：Python虚拟环境部署方案补充](chapter1/grammar.md)
    - 第二章 数据准备
        - [第一节 数据加载](chapter2/grammar.md)
